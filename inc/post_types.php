...
function cc_post_type_student_story() {

    $labels = array(
        'name'                  => 'Student story',
        'singular_name'         => 'Student story',
        'menu_name'             => 'Student stories',
        'name_admin_bar'        => 'Student stories',
        'archives'              => 'Student story Archives',
        'parent_item_colon'     => 'Parent Item:',
        'all_items'             => 'All Items',
        'add_new_item'          => 'Add New Item',
        'add_new'               => 'Add New Student story',
        'new_item'              => 'New Student story',
        'edit_item'             => 'Edit Student story',
        'update_item'           => 'Update Student story',
    ...
    register_post_type( 'studentstory', $args );

}

add_action( 'init', 'cc_post_type_student_story', 0 );
